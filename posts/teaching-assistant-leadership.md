---
title: "Balancing Academics and Mentorship: Reflections on 5 Semesters as a Teaching Assistant"
date: "2026-02-22"
excerpt: "A deep dive into the challenges and rewards of serving as a Teaching Assistant at UGM for five semesters, focusing on time management and academic coordination."
tags: ["Teaching", "Leadership", "Time Management", "Academic"]
img: "/images/blog/teaching-assistant-leadership.png"
...
Serving under the guidance of [Dr. Teguh Bharata Adji, S.T., M.T., M.Eng., Ph.D.](https://acadstaff.ugm.ac.id/tba), this role was a masterclass in communication and empathy. While technical prowess is essential for the subjects taught, the true test of a Teaching Assistant lies in the ability to orchestrate the learning experience for hundreds of students seamlessly.

![Dark-themed conceptual illustration representing mentorship and academic synchronization](/images/blog/teaching-assistant-leadership.png)

## The Challenge: Handling the Academic Triad

The core complexity of being a Teaching Assistant is operating at the intersection of three groups: students, academic staff (tenaga pendidik), and the lead lecturer. 

Over five semesters, the most persistent challenges included:
1.  **Time Management Under Pressure:** Balancing my own rigorous academic load as an Information Engineering student while dedicating substantial hours to assist others.
2.  **Digital Logistics & Automation:** Preparing and migrating complex practical materials, mid-term (UTS), and final exams (UAS) onto the university's e-learning platform [ELOK](https://elok.ugm.ac.id/) flawlessly. Furthermore, extracting and processing the final grades for hundreds of students at the end of every semester was a massive logistical hurdle.
...
Instead of manual data entry, my script processed the grades and automatically generated the required faculty reports. This included calculating and formatting the highest and lowest scores in a matter of seconds, saving hours of administrative work and ensuring 100% accuracy for the final faculty submission.
...
Serving as a Teaching Assistant was one of the most demanding yet rewarding experiences of my undergraduate career. It taught me that whether you are deploying a robust microservice or deploying a final exam to an e-learning platform, success ultimately relies on clear communication and empathy for the end-user.

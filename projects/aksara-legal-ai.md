...
Aksara Legal AI addresses the regulatory burden faced by Indonesian micro, small, and medium enterprises (MSMEs/UMKM). Handling permits like PIRT (home industry food registration), Halal certification, and BPOM product registration requires deciphering dense legal jargon and managing paperwork across multiple government agencies. Expensive legal consultants cost Rp 500k–1.5M per permit, which small business owners like our target persona "Sari Dewi," founder of a growing kopi business in Sleman, DIY, cannot afford.
...
A 3-person team under **Sumbu Labs** built this for the **National Vibe Coding** hackathon.
...
- Regulatory bodies write official guidelines in dense legal language with no plain-language summaries
- Administrative paperwork consumes dozens of hours per permit: form filling and document compliance
...
This is a hackathon prototype: the Autopilot generates drafts, not legally-binding documents. A real production version would require human-in-the-loop review and direct government system integration.

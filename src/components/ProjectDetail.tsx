  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#0A0A0A] text-[#E0E0E0] selection:bg-amber-400 selection:text-black scroll-smooth">
        <FloatingMenu items={[{ name: "All Projects", href: "/projects", isExternal: true }, { name: "Home", href: "/", isExternal: true }, { name: "Blog", href: "/blog", isExternal: true }, { name: "Contact", href: "mailto:maulana17anjari@gmail.com", isExternal: true }]} />
        <motion.div

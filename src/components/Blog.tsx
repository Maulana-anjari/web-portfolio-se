...
export function BlogIndex() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#0A0A0A] pt-32 pb-48 px-6 md:px-20">
        <FloatingMenu items={[{ name: "Home", href: "/", isExternal: true }, { name: "Blog", href: "/blog", isExternal: true }, { name: "Projects", href: "/projects", isExternal: true }, { name: "Contact", href: "mailto:maulana17anjari@gmail.com", isExternal: true }]} />
        <div className="max-w-7xl mx-auto">
